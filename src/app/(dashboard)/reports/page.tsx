  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Analyze your inventory performance and trends</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-border/60 bg-white px-6 py-20 text-center">
        ...
        <p className="mt-1.5 max-w-sm text-sm text-muted-foreground">
          Stock valuation, sales analytics, and demand forecasting reports will be available in Phase 5.
        </p>
