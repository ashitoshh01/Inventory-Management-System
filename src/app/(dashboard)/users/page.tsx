  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Manage team members and their access roles</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-border/60 bg-white px-6 py-20 text-center">
        ...
        <p className="mt-1.5 max-w-sm text-sm text-muted-foreground">
          User CRUD, role assignment, and warehouse access control will be available in Phase 2.
        </p>
