  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Track customer orders and fulfillment</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-border/60 bg-white px-6 py-20 text-center">
        ...
        <h2 className="text-lg font-semibold text-foreground">Sales Management</h2>
        <p className="mt-1.5 max-w-sm text-sm text-muted-foreground">
          Sales orders, customer management, and invoicing will be available in Phase 3.
        </p>
